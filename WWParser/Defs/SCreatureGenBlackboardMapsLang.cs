...
public struct SCreatureGenBlackboardMapsLang : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static SCreatureGenBlackboardMapsLang GetRootAsSCreatureGenBlackboardMapsLang(ByteBuffer _bb) { return GetRootAsSCreatureGenBlackboardMapsLang(_bb, new SCreatureGenBlackboardMapsLang()); }
  public static SCreatureGenBlackboardMapsLang GetRootAsSCreatureGenBlackboardMapsLang(ByteBuffer _bb, SCreatureGenBlackboardMapsLang obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SCreatureGenBlackboardMapsLang __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public WWParser.Defs.DicStringInt? MapString(int j) { int o = __p.__offset(4); return o != 0 ? (WWParser.Defs.DicStringInt?)(new WWParser.Defs.DicStringInt()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<WWParser.Defs.SCreatureGenBlackboardMapsLang> CreateSCreatureGenBlackboardMapsLang(FlatBufferBuilder builder,
    ...
    SCreatureGenBlackboardMapsLang.AddMapBool(builder, map_boolOffset);
    SCreatureGenBlackboardMapsLang.AddMapInt(builder, map_intOffset);
    SCreatureGenBlackboardMapsLang.AddMapString(builder, map_stringOffset);
    return SCreatureGenBlackboardMapsLang.EndSCreatureGenBlackboardMapsLang(builder);
  }

  public static void StartSCreatureGenBlackboardMapsLang(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static VectorOffset CreateMapStringVector(FlatBufferBuilder builder, Offset<WWParser.Defs.DicStringInt>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateMapStringVectorBlock(FlatBufferBuilder builder, Offset<WWParser.Defs.DicStringInt>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateMapStringVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<WWParser.Defs.DicStringInt>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateMapStringVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<WWParser.Defs.DicStringInt>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<WWParser.Defs.SCreatureGenBlackboardMapsLang> EndSCreatureGenBlackboardMapsLang(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.SCreatureGenBlackboardMapsLang>(o);
  }
  public SCreatureGenBlackboardMapsLangT UnPack() {
    var _o = new SCreatureGenBlackboardMapsLangT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SCreatureGenBlackboardMapsLangT _o) {
    _o.MapString = new List<WWParser.Defs.DicStringIntT>();
  ...
  public static Offset<WWParser.Defs.SCreatureGenBlackboardMapsLang> Pack(FlatBufferBuilder builder, SCreatureGenBlackboardMapsLangT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.SCreatureGenBlackboardMapsLang>);
    var _map_string = default(VectorOffset);
    if (_o.MapString != null) {
      var __map_string = new Offset<WWParser.Defs.DicStringInt>[_o.MapString.Count];
      for (var _j = 0; _j < __map_string.Length; ++_j) { __map_string[_j] = WWParser.Defs.DicStringInt.Pack(builder, _o.MapString[_j]); }
    ...
    return CreateSCreatureGenBlackboardMapsLang(
      builder,
      _map_string,
      _map_int,
      _map_bool);
...
public class SCreatureGenBlackboardMapsLangT
{
  [Newtonsoft.Json.JsonProperty("map_string")]
  public List<WWParser.Defs.DicStringIntT> MapString { get; set; }
  ...
  public SCreatureGenBlackboardMapsLangT() {
    this.MapString = null;
    this.MapInt = null;
    this.MapBool = null;
  }
...
static public class SCreatureGenBlackboardMapsLangVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyVectorOfTables(tablePos, 4 /*MapString*/, WWParser.Defs.DicStringIntVerify.Verify, false)
