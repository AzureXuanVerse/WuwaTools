...
public struct RogueResCharacter : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static RogueResCharacter GetRootAsRogueResCharacter(ByteBuffer _bb) { return GetRootAsRogueResCharacter(_bb, new RogueResCharacter()); }
  public static RogueResCharacter GetRootAsRogueResCharacter(ByteBuffer _bb, RogueResCharacter obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RogueResCharacter __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.RogueResCharacter> CreateRogueResCharacter(FlatBufferBuilder builder,
      int id = 0,
      int role_id = 0,
      int quality = 1,
    ...
    RogueResCharacter.AddRoleBigIcon(builder, role_big_iconOffset);
    RogueResCharacter.AddRoleName(builder, role_nameOffset);
    RogueResCharacter.AddRoleIcon(builder, role_iconOffset);
    RogueResCharacter.AddQuality(builder, quality);
    RogueResCharacter.AddRoleId(builder, role_id);
    RogueResCharacter.AddId(builder, id);
    return RogueResCharacter.EndRogueResCharacter(builder);
  }

  public static void StartRogueResCharacter(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<WWParser.Defs.RogueResCharacter> EndRogueResCharacter(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.RogueResCharacter>(o);
  }
  public RogueResCharacterT UnPack() {
    var _o = new RogueResCharacterT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RogueResCharacterT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.RogueResCharacter> Pack(FlatBufferBuilder builder, RogueResCharacterT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.RogueResCharacter>);
    ...
    return CreateRogueResCharacter(
      builder,
      _o.Id,
      _o.RoleId,
      _o.Quality,
...
public class RogueResCharacterT
{
...
static public class RogueResCharacterVerify
{
