...
public struct SetAccount : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static SetAccount GetRootAsSetAccount(ByteBuffer _bb) { return GetRootAsSetAccount(_bb, new SetAccount()); }
  public static SetAccount GetRootAsSetAccount(ByteBuffer _bb, SetAccount obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SetAccount __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.SetAccount> CreateSetAccount(FlatBufferBuilder builder,
      int id = 0,
      int package_type = 0,
    ...
    SetAccount.AddAdress(builder, adressOffset);
    SetAccount.AddChannel(builder, channelOffset);
    SetAccount.AddPackageId(builder, package_idOffset);
    SetAccount.AddLanguage(builder, languageOffset);
    SetAccount.AddPackageType(builder, package_type);
    SetAccount.AddId(builder, id);
    return SetAccount.EndSetAccount(builder);
  }

  public static void StartSetAccount(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<WWParser.Defs.SetAccount> EndSetAccount(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.SetAccount>(o);
  }
  public SetAccountT UnPack() {
    var _o = new SetAccountT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SetAccountT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.SetAccount> Pack(FlatBufferBuilder builder, SetAccountT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.SetAccount>);
...
static public class SetAccountVerify
{
