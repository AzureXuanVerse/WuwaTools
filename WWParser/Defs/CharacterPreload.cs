...
public struct CharacterPreload : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static CharacterPreload GetRootAsCharacterPreload(ByteBuffer _bb) { return GetRootAsCharacterPreload(_bb, new CharacterPreload()); }
  public static CharacterPreload GetRootAsCharacterPreload(ByteBuffer _bb, CharacterPreload obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public CharacterPreload __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public int Id { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int AiId { get { int o = __p.__offset(6); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<WWParser.Defs.CharacterPreload> CreateCharacterPreload(FlatBufferBuilder builder,
      int id = 0,
      int ai_id = 0,
    ...
    CharacterPreload.AddOthers(builder, othersOffset);
    CharacterPreload.AddAnimationBlueprints(builder, animation_blueprintsOffset);
    CharacterPreload.AddMaterials(builder, materialsOffset);
    CharacterPreload.AddMeshes(builder, meshesOffset);
    CharacterPreload.AddAudios(builder, audiosOffset);
    CharacterPreload.AddEffects(builder, effectsOffset);
    CharacterPreload.AddAnimations(builder, animationsOffset);
    CharacterPreload.AddActorClass(builder, actor_classOffset);
    CharacterPreload.AddAiId(builder, ai_id);
    CharacterPreload.AddId(builder, id);
    return CharacterPreload.EndCharacterPreload(builder);
  }

  public static void StartCharacterPreload(FlatBufferBuilder builder) { builder.StartTable(10); }
  public static void AddId(FlatBufferBuilder builder, int id) { builder.AddInt(0, id, 0); }
  public static void AddAiId(FlatBufferBuilder builder, int aiId) { builder.AddInt(1, aiId, 0); }
  ...
  public static Offset<WWParser.Defs.CharacterPreload> EndCharacterPreload(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.CharacterPreload>(o);
  }
  public CharacterPreloadT UnPack() {
    var _o = new CharacterPreloadT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(CharacterPreloadT _o) {
    _o.Id = this.Id;
    _o.AiId = this.AiId;
  ...
  public static Offset<WWParser.Defs.CharacterPreload> Pack(FlatBufferBuilder builder, CharacterPreloadT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.CharacterPreload>);
...
public class CharacterPreloadT
{
...
static public class CharacterPreloadVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*Id*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 6 /*AiId*/, 4 /*int*/, 4, false)
