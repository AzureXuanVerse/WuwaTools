...
public struct TreasureBoxMark : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static TreasureBoxMark GetRootAsTreasureBoxMark(ByteBuffer _bb) { return GetRootAsTreasureBoxMark(_bb, new TreasureBoxMark()); }
  public static TreasureBoxMark GetRootAsTreasureBoxMark(ByteBuffer _bb, TreasureBoxMark obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public TreasureBoxMark __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.TreasureBoxMark> CreateTreasureBoxMark(FlatBufferBuilder builder,
      int mark_id = 0,
    ...
    TreasureBoxMark.AddScale(builder, scale);
    TreasureBoxMark.AddShowRange(builder, show_rangeOffset);
    TreasureBoxMark.AddShowPriority(builder, show_priority);
    TreasureBoxMark.AddMarkDesc(builder, mark_descOffset);
    TreasureBoxMark.AddMarkTitle(builder, mark_titleOffset);
    TreasureBoxMark.AddMarkPic(builder, mark_picOffset);
    TreasureBoxMark.AddMarkId(builder, mark_id);
    return TreasureBoxMark.EndTreasureBoxMark(builder);
  }

  public static void StartTreasureBoxMark(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static Offset<WWParser.Defs.TreasureBoxMark> EndTreasureBoxMark(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.TreasureBoxMark>(o);
  }
  public TreasureBoxMarkT UnPack() {
    var _o = new TreasureBoxMarkT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TreasureBoxMarkT _o) {
  ...
  public static Offset<WWParser.Defs.TreasureBoxMark> Pack(FlatBufferBuilder builder, TreasureBoxMarkT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.TreasureBoxMark>);
...
static public class TreasureBoxMarkVerify
{
