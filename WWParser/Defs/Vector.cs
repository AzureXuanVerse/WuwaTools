...
public struct Vector : IFlatbufferObject
{
  ...
  public static Offset<WWParser.Defs.Vector> CreateVector(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
  ...
  public static Offset<WWParser.Defs.Vector> EndVector(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.Vector>(o);
  }
  ...
  public static Offset<WWParser.Defs.Vector> Pack(FlatBufferBuilder builder, VectorT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.Vector>);
    return CreateVector(
      builder,
      _o.X,
      _o.Y,
