...
public struct RogueCurrency : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static RogueCurrency GetRootAsRogueCurrency(ByteBuffer _bb) { return GetRootAsRogueCurrency(_bb, new RogueCurrency()); }
  public static RogueCurrency GetRootAsRogueCurrency(ByteBuffer _bb, RogueCurrency obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RogueCurrency __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.RogueCurrency> CreateRogueCurrency(FlatBufferBuilder builder,
      int id = 0,
      int quality_id = 1,
    ...
    RogueCurrency.AddRedDotDisableRule(builder, red_dot_disable_rule);
    RogueCurrency.AddTips(builder, tipsOffset);
    RogueCurrency.AddBgDescription(builder, bg_descriptionOffset);
    RogueCurrency.AddTypeDescription(builder, type_descriptionOffset);
    RogueCurrency.AddObtainedShowDescription(builder, obtained_show_descriptionOffset);
    RogueCurrency.AddAttributesDescription(builder, attributes_descriptionOffset);
    RogueCurrency.AddTitle(builder, titleOffset);
    RogueCurrency.AddIconSmall(builder, icon_smallOffset);
    RogueCurrency.AddIconMiddle(builder, icon_middleOffset);
    RogueCurrency.AddIcon(builder, iconOffset);
    RogueCurrency.AddImagePath(builder, image_pathOffset);
    RogueCurrency.AddSortIndex(builder, sort_index);
    RogueCurrency.AddItemAccess(builder, item_accessOffset);
    RogueCurrency.AddQualityId(builder, quality_id);
    RogueCurrency.AddId(builder, id);
    RogueCurrency.AddShowInBag(builder, show_in_bag);
    return RogueCurrency.EndRogueCurrency(builder);
  }

  public static void StartRogueCurrency(FlatBufferBuilder builder) { builder.StartTable(16); }
  ...
  public static Offset<WWParser.Defs.RogueCurrency> EndRogueCurrency(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.RogueCurrency>(o);
  }
  public RogueCurrencyT UnPack() {
    var _o = new RogueCurrencyT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RogueCurrencyT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.RogueCurrency> Pack(FlatBufferBuilder builder, RogueCurrencyT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.RogueCurrency>);
...
static public class RogueCurrencyVerify
{
