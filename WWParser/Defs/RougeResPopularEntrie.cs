...
public struct RougeResPopularEntrie : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static RougeResPopularEntrie GetRootAsRougeResPopularEntrie(ByteBuffer _bb) { return GetRootAsRougeResPopularEntrie(_bb, new RougeResPopularEntrie()); }
  public static RougeResPopularEntrie GetRootAsRougeResPopularEntrie(ByteBuffer _bb, RougeResPopularEntrie obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RougeResPopularEntrie __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.RougeResPopularEntrie> CreateRougeResPopularEntrie(FlatBufferBuilder builder,
      int id = 0,
      int category = 0,
      int rate = 0,
    ...
    RougeResPopularEntrie.AddDescriptionParam(builder, description_paramOffset);
    RougeResPopularEntrie.AddDescribe(builder, describeOffset);
    RougeResPopularEntrie.AddTitle(builder, titleOffset);
    RougeResPopularEntrie.AddIcon(builder, iconOffset);
    RougeResPopularEntrie.AddInsts(builder, instsOffset);
    RougeResPopularEntrie.AddRate(builder, rate);
    RougeResPopularEntrie.AddCategory(builder, category);
    RougeResPopularEntrie.AddId(builder, id);
    return RougeResPopularEntrie.EndRougeResPopularEntrie(builder);
  }

  public static void StartRougeResPopularEntrie(FlatBufferBuilder builder) { builder.StartTable(8); }
  ...
  public static Offset<WWParser.Defs.RougeResPopularEntrie> EndRougeResPopularEntrie(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.RougeResPopularEntrie>(o);
  }
  public RougeResPopularEntrieT UnPack() {
    var _o = new RougeResPopularEntrieT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RougeResPopularEntrieT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.RougeResPopularEntrie> Pack(FlatBufferBuilder builder, RougeResPopularEntrieT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.RougeResPopularEntrie>);
    ...
    return CreateRougeResPopularEntrie(
      builder,
      _o.Id,
      _o.Category,
      _o.Rate,
...
public class RougeResPopularEntrieT
{
...
static public class RougeResPopularEntrieVerify
{
