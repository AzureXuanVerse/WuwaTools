...
public struct RoleSkinTrialActivity : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static RoleSkinTrialActivity GetRootAsRoleSkinTrialActivity(ByteBuffer _bb) { return GetRootAsRoleSkinTrialActivity(_bb, new RoleSkinTrialActivity()); }
  public static RoleSkinTrialActivity GetRootAsRoleSkinTrialActivity(ByteBuffer _bb, RoleSkinTrialActivity obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RoleSkinTrialActivity __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.RoleSkinTrialActivity> CreateRoleSkinTrialActivity(FlatBufferBuilder builder,
      int id = 0,
      VectorOffset role_id_listOffset = default(VectorOffset)) {
    builder.StartTable(2);
    RoleSkinTrialActivity.AddRoleIdList(builder, role_id_listOffset);
    RoleSkinTrialActivity.AddId(builder, id);
    return RoleSkinTrialActivity.EndRoleSkinTrialActivity(builder);
  }

  public static void StartRoleSkinTrialActivity(FlatBufferBuilder builder) { builder.StartTable(2); }
  ...
  public static Offset<WWParser.Defs.RoleSkinTrialActivity> EndRoleSkinTrialActivity(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.RoleSkinTrialActivity>(o);
  }
  public RoleSkinTrialActivityT UnPack() {
    var _o = new RoleSkinTrialActivityT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RoleSkinTrialActivityT _o) {
    _o.Id = this.Id;
    _o.RoleIdList = new List<int>();
    for (var _j = 0; _j < this.RoleIdListLength; ++_j) {_o.RoleIdList.Add(this.RoleIdList(_j));}
  }
  public static Offset<WWParser.Defs.RoleSkinTrialActivity> Pack(FlatBufferBuilder builder, RoleSkinTrialActivityT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.RoleSkinTrialActivity>);
    ...
    return CreateRoleSkinTrialActivity(
      builder,
      _o.Id,
      _role_id_list);
  }
...
public class RoleSkinTrialActivityT
{
...
static public class RoleSkinTrialActivityVerify
{
