...
public struct PbDataPreload : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static PbDataPreload GetRootAsPbDataPreload(ByteBuffer _bb) { return GetRootAsPbDataPreload(_bb, new PbDataPreload()); }
  public static PbDataPreload GetRootAsPbDataPreload(ByteBuffer _bb, PbDataPreload obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public PbDataPreload __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public int Id { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int MapId { get { int o = __p.__offset(6); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int PbDataId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<WWParser.Defs.PbDataPreload> CreatePbDataPreload(FlatBufferBuilder builder,
      int id = 0,
      int map_id = 0,
      int pb_data_id = 0,
    ...
    PbDataPreload.AddOthers(builder, othersOffset);
    PbDataPreload.AddAnimationBlueprints(builder, animation_blueprintsOffset);
    PbDataPreload.AddMaterials(builder, materialsOffset);
    PbDataPreload.AddMeshes(builder, meshesOffset);
    PbDataPreload.AddAudios(builder, audiosOffset);
    PbDataPreload.AddEffects(builder, effectsOffset);
    PbDataPreload.AddAnimations(builder, animationsOffset);
    PbDataPreload.AddActorClass(builder, actor_classOffset);
    PbDataPreload.AddPbDataId(builder, pb_data_id);
    PbDataPreload.AddMapId(builder, map_id);
    PbDataPreload.AddId(builder, id);
    return PbDataPreload.EndPbDataPreload(builder);
  }

  public static void StartPbDataPreload(FlatBufferBuilder builder) { builder.StartTable(11); }
  public static void AddId(FlatBufferBuilder builder, int id) { builder.AddInt(0, id, 0); }
  public static void AddMapId(FlatBufferBuilder builder, int mapId) { builder.AddInt(1, mapId, 0); }
  public static void AddPbDataId(FlatBufferBuilder builder, int pbDataId) { builder.AddInt(2, pbDataId, 0); }
  ...
  public static Offset<WWParser.Defs.PbDataPreload> EndPbDataPreload(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.PbDataPreload>(o);
  }
  public PbDataPreloadT UnPack() {
    var _o = new PbDataPreloadT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PbDataPreloadT _o) {
    _o.Id = this.Id;
    _o.MapId = this.MapId;
  ...
  public static Offset<WWParser.Defs.PbDataPreload> Pack(FlatBufferBuilder builder, PbDataPreloadT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.PbDataPreload>);
...
static public class PbDataPreloadVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*PbDataId*/, 4 /*int*/, 4, false)
