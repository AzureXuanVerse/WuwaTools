...
public struct ElementLevel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static ElementLevel GetRootAsElementLevel(ByteBuffer _bb) { return GetRootAsElementLevel(_bb, new ElementLevel()); }
  public static ElementLevel GetRootAsElementLevel(ByteBuffer _bb, ElementLevel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ElementLevel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.ElementLevel> CreateElementLevel(FlatBufferBuilder builder,
      int level = 0,
      double buff_id = 0.0,
    ...
    ElementLevel.AddBuffId(builder, buff_id);
    ElementLevel.AddTextIdArgs(builder, text_id_argsOffset);
    ElementLevel.AddTextId(builder, text_idOffset);
    ElementLevel.AddAddBuffs(builder, add_buffsOffset);
    ElementLevel.AddLevel(builder, level);
    return ElementLevel.EndElementLevel(builder);
  }

  public static void StartElementLevel(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<WWParser.Defs.ElementLevel> EndElementLevel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.ElementLevel>(o);
  }
  public ElementLevelT UnPack() {
    var _o = new ElementLevelT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ElementLevelT _o) {
    _o.Level = this.Level;
  ...
  public static Offset<WWParser.Defs.ElementLevel> Pack(FlatBufferBuilder builder, ElementLevelT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.ElementLevel>);
...
static public class ElementLevelVerify
{
