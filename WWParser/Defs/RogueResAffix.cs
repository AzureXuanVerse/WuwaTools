...
public struct RogueResAffix : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static RogueResAffix GetRootAsRogueResAffix(ByteBuffer _bb) { return GetRootAsRogueResAffix(_bb, new RogueResAffix()); }
  public static RogueResAffix GetRootAsRogueResAffix(ByteBuffer _bb, RogueResAffix obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RogueResAffix __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.RogueResAffix> CreateRogueResAffix(FlatBufferBuilder builder,
      int id = 0,
    ...
    RogueResAffix.AddAffixDescSimple(builder, affix_desc_simpleOffset);
    RogueResAffix.AddAffixDescParam(builder, affix_desc_paramOffset);
    RogueResAffix.AddAffixDesc(builder, affix_descOffset);
    RogueResAffix.AddBuffId(builder, buff_idOffset);
    RogueResAffix.AddId(builder, id);
    return RogueResAffix.EndRogueResAffix(builder);
  }

  public static void StartRogueResAffix(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<WWParser.Defs.RogueResAffix> EndRogueResAffix(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.RogueResAffix>(o);
  }
  public RogueResAffixT UnPack() {
    var _o = new RogueResAffixT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RogueResAffixT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.RogueResAffix> Pack(FlatBufferBuilder builder, RogueResAffixT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.RogueResAffix>);
...
static public class RogueResAffixVerify
{
