...
public struct CustomerService : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static CustomerService GetRootAsCustomerService(ByteBuffer _bb) { return GetRootAsCustomerService(_bb, new CustomerService()); }
  public static CustomerService GetRootAsCustomerService(ByteBuffer _bb, CustomerService obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public CustomerService __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.CustomerService> CreateCustomerService(FlatBufferBuilder builder,
      int id = 0,
      int package_type = 0,
    ...
    CustomerService.AddChannel(builder, channelOffset);
    CustomerService.AddPackageId(builder, package_idOffset);
    CustomerService.AddLanguage(builder, languageOffset);
    CustomerService.AddPackageType(builder, package_type);
    CustomerService.AddId(builder, id);
    return CustomerService.EndCustomerService(builder);
  }

  public static void StartCustomerService(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<WWParser.Defs.CustomerService> EndCustomerService(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.CustomerService>(o);
  }
  public CustomerServiceT UnPack() {
    var _o = new CustomerServiceT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(CustomerServiceT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.CustomerService> Pack(FlatBufferBuilder builder, CustomerServiceT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.CustomerService>);
...
static public class CustomerServiceVerify
{
