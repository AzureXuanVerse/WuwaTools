...
public struct ModelConfigPreload : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static ModelConfigPreload GetRootAsModelConfigPreload(ByteBuffer _bb) { return GetRootAsModelConfigPreload(_bb, new ModelConfigPreload()); }
  public static ModelConfigPreload GetRootAsModelConfigPreload(ByteBuffer _bb, ModelConfigPreload obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ModelConfigPreload __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public int Id { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public string ActorClassPath { get { int o = __p.__offset(6); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetActorClassPathBytes() { return __p.__vector_as_span<byte>(6, 1); }
#else
  public ArraySegment<byte>? GetActorClassPathBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public byte[] GetActorClassPathArray() { return __p.__vector_as_array<byte>(6); }
  public string ActorClass(int j) { int o = __p.__offset(8); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ActorClassLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Animations(int j) { int o = __p.__offset(10); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AnimationsLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Effects(int j) { int o = __p.__offset(12); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int EffectsLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Audios(int j) { int o = __p.__offset(14); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AudiosLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Meshes(int j) { int o = __p.__offset(16); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int MeshesLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Materials(int j) { int o = __p.__offset(18); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int MaterialsLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string AnimationBlueprints(int j) { int o = __p.__offset(20); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AnimationBlueprintsLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Others(int j) { int o = __p.__offset(22); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int OthersLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<WWParser.Defs.ModelConfigPreload> CreateModelConfigPreload(FlatBufferBuilder builder,
      int id = 0,
      StringOffset actor_class_pathOffset = default(StringOffset),
    ...
    ModelConfigPreload.AddOthers(builder, othersOffset);
    ModelConfigPreload.AddAnimationBlueprints(builder, animation_blueprintsOffset);
    ModelConfigPreload.AddMaterials(builder, materialsOffset);
    ModelConfigPreload.AddMeshes(builder, meshesOffset);
    ModelConfigPreload.AddAudios(builder, audiosOffset);
    ModelConfigPreload.AddEffects(builder, effectsOffset);
    ModelConfigPreload.AddAnimations(builder, animationsOffset);
    ModelConfigPreload.AddActorClass(builder, actor_classOffset);
    ModelConfigPreload.AddActorClassPath(builder, actor_class_pathOffset);
    ModelConfigPreload.AddId(builder, id);
    return ModelConfigPreload.EndModelConfigPreload(builder);
  }

  public static void StartModelConfigPreload(FlatBufferBuilder builder) { builder.StartTable(10); }
  public static void AddId(FlatBufferBuilder builder, int id) { builder.AddInt(0, id, 0); }
  public static void AddActorClassPath(FlatBufferBuilder builder, StringOffset actorClassPathOffset) { builder.AddOffset(1, actorClassPathOffset.Value, 0); }
  public static void AddActorClass(FlatBufferBuilder builder, VectorOffset actorClassOffset) { builder.AddOffset(2, actorClassOffset.Value, 0); }
  ...
  public static void AddAnimations(FlatBufferBuilder builder, VectorOffset animationsOffset) { builder.AddOffset(3, animationsOffset.Value, 0); }
  ...
  public static void AddEffects(FlatBufferBuilder builder, VectorOffset effectsOffset) { builder.AddOffset(4, effectsOffset.Value, 0); }
  ...
  public static void AddAudios(FlatBufferBuilder builder, VectorOffset audiosOffset) { builder.AddOffset(5, audiosOffset.Value, 0); }
  ...
  public static void AddMeshes(FlatBufferBuilder builder, VectorOffset meshesOffset) { builder.AddOffset(6, meshesOffset.Value, 0); }
  ...
  public static void AddMaterials(FlatBufferBuilder builder, VectorOffset materialsOffset) { builder.AddOffset(7, materialsOffset.Value, 0); }
  ...
  public static void AddAnimationBlueprints(FlatBufferBuilder builder, VectorOffset animationBlueprintsOffset) { builder.AddOffset(8, animationBlueprintsOffset.Value, 0); }
  ...
  public static void AddOthers(FlatBufferBuilder builder, VectorOffset othersOffset) { builder.AddOffset(9, othersOffset.Value, 0); }
  ...
  public static Offset<WWParser.Defs.ModelConfigPreload> EndModelConfigPreload(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.ModelConfigPreload>(o);
  }
  public ModelConfigPreloadT UnPack() {
    var _o = new ModelConfigPreloadT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ModelConfigPreloadT _o) {
    _o.Id = this.Id;
    _o.ActorClassPath = this.ActorClassPath;
  ...
  public static Offset<WWParser.Defs.ModelConfigPreload> Pack(FlatBufferBuilder builder, ModelConfigPreloadT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.ModelConfigPreload>);
    var _actor_class_path = _o.ActorClassPath == null ? default(StringOffset) : builder.CreateString(_o.ActorClassPath);
    ...
    return CreateModelConfigPreload(
      builder,
      _o.Id,
      _actor_class_path,
      _actor_class,
...
public class ModelConfigPreloadT
{
  [Newtonsoft.Json.JsonProperty("id")]
  public int Id { get; set; }
  [Newtonsoft.Json.JsonProperty("actor_class_path")]
...
static public class ModelConfigPreloadVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*Id*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 6 /*ActorClassPath*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 8 /*ActorClass*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 10 /*Animations*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 12 /*Effects*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 14 /*Audios*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 16 /*Meshes*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 18 /*Materials*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 20 /*AnimationBlueprints*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 22 /*Others*/, false)
