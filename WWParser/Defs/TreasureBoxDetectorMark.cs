...
public struct TreasureBoxDetectorMark : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static TreasureBoxDetectorMark GetRootAsTreasureBoxDetectorMark(ByteBuffer _bb) { return GetRootAsTreasureBoxDetectorMark(_bb, new TreasureBoxDetectorMark()); }
  public static TreasureBoxDetectorMark GetRootAsTreasureBoxDetectorMark(ByteBuffer _bb, TreasureBoxDetectorMark obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public TreasureBoxDetectorMark __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.TreasureBoxDetectorMark> CreateTreasureBoxDetectorMark(FlatBufferBuilder builder,
      int mark_id = 0,
    ...
    TreasureBoxDetectorMark.AddTrackAutoCancelDistance(builder, track_auto_cancel_distance);
    TreasureBoxDetectorMark.AddTrackHudEnable(builder, track_hud_enable);
    TreasureBoxDetectorMark.AddScale(builder, scale);
    TreasureBoxDetectorMark.AddShowRange(builder, show_rangeOffset);
    TreasureBoxDetectorMark.AddShowPriority(builder, show_priority);
    TreasureBoxDetectorMark.AddMarkDesc(builder, mark_descOffset);
    TreasureBoxDetectorMark.AddMarkTitle(builder, mark_titleOffset);
    TreasureBoxDetectorMark.AddMarkPic(builder, mark_picOffset);
    TreasureBoxDetectorMark.AddMarkId(builder, mark_id);
    return TreasureBoxDetectorMark.EndTreasureBoxDetectorMark(builder);
  }

  public static void StartTreasureBoxDetectorMark(FlatBufferBuilder builder) { builder.StartTable(9); }
  ...
  public static Offset<WWParser.Defs.TreasureBoxDetectorMark> EndTreasureBoxDetectorMark(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.TreasureBoxDetectorMark>(o);
  }
  public TreasureBoxDetectorMarkT UnPack() {
    var _o = new TreasureBoxDetectorMarkT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TreasureBoxDetectorMarkT _o) {
  ...
  public static Offset<WWParser.Defs.TreasureBoxDetectorMark> Pack(FlatBufferBuilder builder, TreasureBoxDetectorMarkT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.TreasureBoxDetectorMark>);
    ...
    return CreateTreasureBoxDetectorMark(
      builder,
      _o.MarkId,
      _mark_pic,
      _mark_title,
...
public class TreasureBoxDetectorMarkT
{
  ...
  public TreasureBoxDetectorMarkT() {
    this.MarkId = 0;
    this.MarkPic = null;
    this.MarkTitle = null;
    this.MarkDesc = null;
...
static public class TreasureBoxDetectorMarkVerify
{
