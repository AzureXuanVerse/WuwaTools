...
public struct UiCameraMapping : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static UiCameraMapping GetRootAsUiCameraMapping(ByteBuffer _bb) { return GetRootAsUiCameraMapping(_bb, new UiCameraMapping()); }
  public static UiCameraMapping GetRootAsUiCameraMapping(ByteBuffer _bb, UiCameraMapping obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public UiCameraMapping __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.UiCameraMapping> CreateUiCameraMapping(FlatBufferBuilder builder,
      int id = 0,
    ...
    UiCameraMapping.AddUiCameraDelayTime(builder, ui_camera_delay_time);
    UiCameraMapping.AddUiCameraBlendNameMap(builder, ui_camera_blend_name_mapOffset);
    UiCameraMapping.AddDefaultCameraBlendName(builder, default_camera_blend_nameOffset);
    UiCameraMapping.AddBodyCameraSettingsNameMap(builder, body_camera_settings_name_mapOffset);
    UiCameraMapping.AddBodyTargetType(builder, body_target_type);
    UiCameraMapping.AddSpecialStateCameraSettingName(builder, special_state_camera_setting_nameOffset);
    UiCameraMapping.AddDefaultUiCameraSettingsName(builder, default_ui_camera_settings_nameOffset);
    UiCameraMapping.AddViewName(builder, view_nameOffset);
    UiCameraMapping.AddId(builder, id);
    UiCameraMapping.AddBPlayLoadingCameraAnimation(builder, b_play_loading_camera_animation);
    UiCameraMapping.AddIsCheckSpecialState(builder, is_check_special_state);
    return UiCameraMapping.EndUiCameraMapping(builder);
  }

  public static void StartUiCameraMapping(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<WWParser.Defs.UiCameraMapping> EndUiCameraMapping(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.UiCameraMapping>(o);
  }
  public UiCameraMappingT UnPack() {
    var _o = new UiCameraMappingT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(UiCameraMappingT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.UiCameraMapping> Pack(FlatBufferBuilder builder, UiCameraMappingT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.UiCameraMapping>);
...
static public class UiCameraMappingVerify
{
