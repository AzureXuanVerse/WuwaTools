...
public struct TemplateDataPreload : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static TemplateDataPreload GetRootAsTemplateDataPreload(ByteBuffer _bb) { return GetRootAsTemplateDataPreload(_bb, new TemplateDataPreload()); }
  public static TemplateDataPreload GetRootAsTemplateDataPreload(ByteBuffer _bb, TemplateDataPreload obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public TemplateDataPreload __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public int Id { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public string ActorClass(int j) { int o = __p.__offset(6); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ActorClassLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Animations(int j) { int o = __p.__offset(8); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AnimationsLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Effects(int j) { int o = __p.__offset(10); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int EffectsLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Audios(int j) { int o = __p.__offset(12); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AudiosLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Meshes(int j) { int o = __p.__offset(14); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int MeshesLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Materials(int j) { int o = __p.__offset(16); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int MaterialsLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string AnimationBlueprints(int j) { int o = __p.__offset(18); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AnimationBlueprintsLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string Others(int j) { int o = __p.__offset(20); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int OthersLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<WWParser.Defs.TemplateDataPreload> CreateTemplateDataPreload(FlatBufferBuilder builder,
      int id = 0,
    ...
    TemplateDataPreload.AddOthers(builder, othersOffset);
    TemplateDataPreload.AddAnimationBlueprints(builder, animation_blueprintsOffset);
    TemplateDataPreload.AddMaterials(builder, materialsOffset);
    TemplateDataPreload.AddMeshes(builder, meshesOffset);
    TemplateDataPreload.AddAudios(builder, audiosOffset);
    TemplateDataPreload.AddEffects(builder, effectsOffset);
    TemplateDataPreload.AddAnimations(builder, animationsOffset);
    TemplateDataPreload.AddActorClass(builder, actor_classOffset);
    TemplateDataPreload.AddId(builder, id);
    return TemplateDataPreload.EndTemplateDataPreload(builder);
  }

  public static void StartTemplateDataPreload(FlatBufferBuilder builder) { builder.StartTable(9); }
  public static void AddId(FlatBufferBuilder builder, int id) { builder.AddInt(0, id, 0); }
  public static void AddActorClass(FlatBufferBuilder builder, VectorOffset actorClassOffset) { builder.AddOffset(1, actorClassOffset.Value, 0); }
  ...
  public static void AddAnimations(FlatBufferBuilder builder, VectorOffset animationsOffset) { builder.AddOffset(2, animationsOffset.Value, 0); }
  ...
  public static void AddEffects(FlatBufferBuilder builder, VectorOffset effectsOffset) { builder.AddOffset(3, effectsOffset.Value, 0); }
  ...
  public static void AddAudios(FlatBufferBuilder builder, VectorOffset audiosOffset) { builder.AddOffset(4, audiosOffset.Value, 0); }
  ...
  public static void AddMeshes(FlatBufferBuilder builder, VectorOffset meshesOffset) { builder.AddOffset(5, meshesOffset.Value, 0); }
  ...
  public static void AddAnimationBlueprints(FlatBufferBuilder builder, VectorOffset animationBlueprintsOffset) { builder.AddOffset(7, animationBlueprintsOffset.Value, 0); }
  ...
  public static void AddOthers(FlatBufferBuilder builder, VectorOffset othersOffset) { builder.AddOffset(8, othersOffset.Value, 0); }
  ...
  public static Offset<WWParser.Defs.TemplateDataPreload> EndTemplateDataPreload(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.TemplateDataPreload>(o);
  }
  public TemplateDataPreloadT UnPack() {
    var _o = new TemplateDataPreloadT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TemplateDataPreloadT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.TemplateDataPreload> Pack(FlatBufferBuilder builder, TemplateDataPreloadT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.TemplateDataPreload>);
    ...
    return CreateTemplateDataPreload(
      builder,
      _o.Id,
      _actor_class,
      _animations,
...
public class TemplateDataPreloadT
{
...
static public class TemplateDataPreloadVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*Id*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfStrings(tablePos, 6 /*ActorClass*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 8 /*Animations*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 10 /*Effects*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 12 /*Audios*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 14 /*Meshes*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 16 /*Materials*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 18 /*AnimationBlueprints*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 20 /*Others*/, false)
