...
public struct RogueEvent : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static RogueEvent GetRootAsRogueEvent(ByteBuffer _bb) { return GetRootAsRogueEvent(_bb, new RogueEvent()); }
  public static RogueEvent GetRootAsRogueEvent(ByteBuffer _bb, RogueEvent obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RogueEvent __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.RogueEvent> CreateRogueEvent(FlatBufferBuilder builder,
      int id = 0,
    ...
    RogueEvent.AddStateId(builder, state_id);
    RogueEvent.AddFlowId(builder, flow_id);
    RogueEvent.AddFlowListName(builder, flow_list_nameOffset);
    RogueEvent.AddArgs(builder, argsOffset);
    RogueEvent.AddEventType(builder, event_type);
    RogueEvent.AddCondition(builder, condition);
    RogueEvent.AddTitle(builder, titleOffset);
    RogueEvent.AddTextId(builder, text_idOffset);
    RogueEvent.AddId(builder, id);
    RogueEvent.AddIsCopyCamera(builder, is_copy_camera);
    return RogueEvent.EndRogueEvent(builder);
  }

  public static void StartRogueEvent(FlatBufferBuilder builder) { builder.StartTable(10); }
  ...
  public static Offset<WWParser.Defs.RogueEvent> EndRogueEvent(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.RogueEvent>(o);
  }
  public RogueEventT UnPack() {
    var _o = new RogueEventT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RogueEventT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WWParser.Defs.RogueEvent> Pack(FlatBufferBuilder builder, RogueEventT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.RogueEvent>);
...
static public class RogueEventVerify
{
