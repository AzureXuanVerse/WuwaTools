...
public struct ChipType : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static ChipType GetRootAsChipType(ByteBuffer _bb) { return GetRootAsChipType(_bb, new ChipType()); }
  public static ChipType GetRootAsChipType(ByteBuffer _bb, ChipType obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ChipType __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WWParser.Defs.ChipType> CreateChipType(FlatBufferBuilder builder,
      int id = 0,
      StringOffset type_descriptionOffset = default(StringOffset),
      StringOffset iconOffset = default(StringOffset)) {
    builder.StartTable(3);
    ChipType.AddIcon(builder, iconOffset);
    ChipType.AddTypeDescription(builder, type_descriptionOffset);
    ChipType.AddId(builder, id);
    return ChipType.EndChipType(builder);
  }

  public static void StartChipType(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<WWParser.Defs.ChipType> EndChipType(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.ChipType>(o);
  }
  public ChipTypeT UnPack() {
    var _o = new ChipTypeT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ChipTypeT _o) {
    _o.Id = this.Id;
    _o.TypeDescription = this.TypeDescription;
    _o.Icon = this.Icon;
  }
  public static Offset<WWParser.Defs.ChipType> Pack(FlatBufferBuilder builder, ChipTypeT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.ChipType>);
    var _type_description = _o.TypeDescription == null ? default(StringOffset) : builder.CreateString(_o.TypeDescription);
    var _icon = _o.Icon == null ? default(StringOffset) : builder.CreateString(_o.Icon);
    return CreateChipType(
      builder,
      _o.Id,
      _type_description,
      _icon);
...
static public class ChipTypeVerify
{
