...
public struct StateMachinePreload : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static StateMachinePreload GetRootAsStateMachinePreload(ByteBuffer _bb) { return GetRootAsStateMachinePreload(_bb, new StateMachinePreload()); }
  public static StateMachinePreload GetRootAsStateMachinePreload(ByteBuffer _bb, StateMachinePreload obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public StateMachinePreload __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public int Id { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public string FsmKey { get { int o = __p.__offset(6); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetFsmKeyBytes() { return __p.__vector_as_span<byte>(6, 1); }
#else
  public ArraySegment<byte>? GetFsmKeyBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public byte[] GetFsmKeyArray() { return __p.__vector_as_array<byte>(6); }
  ...
  public static Offset<WWParser.Defs.StateMachinePreload> CreateStateMachinePreload(FlatBufferBuilder builder,
      int id = 0,
      StringOffset fsm_keyOffset = default(StringOffset),
    ...
    StateMachinePreload.AddOthers(builder, othersOffset);
    StateMachinePreload.AddAnimationBlueprints(builder, animation_blueprintsOffset);
    StateMachinePreload.AddMaterials(builder, materialsOffset);
    StateMachinePreload.AddMeshes(builder, meshesOffset);
    StateMachinePreload.AddAudios(builder, audiosOffset);
    StateMachinePreload.AddEffects(builder, effectsOffset);
    StateMachinePreload.AddAnimations(builder, animationsOffset);
    StateMachinePreload.AddActorClass(builder, actor_classOffset);
    StateMachinePreload.AddFsmKey(builder, fsm_keyOffset);
    StateMachinePreload.AddId(builder, id);
    return StateMachinePreload.EndStateMachinePreload(builder);
  }

  public static void StartStateMachinePreload(FlatBufferBuilder builder) { builder.StartTable(10); }
  public static void AddId(FlatBufferBuilder builder, int id) { builder.AddInt(0, id, 0); }
  public static void AddFsmKey(FlatBufferBuilder builder, StringOffset fsmKeyOffset) { builder.AddOffset(1, fsmKeyOffset.Value, 0); }
  ...
  public static Offset<WWParser.Defs.StateMachinePreload> EndStateMachinePreload(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WWParser.Defs.StateMachinePreload>(o);
  }
  public StateMachinePreloadT UnPack() {
    var _o = new StateMachinePreloadT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(StateMachinePreloadT _o) {
    _o.Id = this.Id;
    _o.FsmKey = this.FsmKey;
  ...
  public static Offset<WWParser.Defs.StateMachinePreload> Pack(FlatBufferBuilder builder, StateMachinePreloadT _o) {
    if (_o == null) return default(Offset<WWParser.Defs.StateMachinePreload>);
    var _fsm_key = _o.FsmKey == null ? default(StringOffset) : builder.CreateString(_o.FsmKey);
    ...
    return CreateStateMachinePreload(
      builder,
      _o.Id,
      _fsm_key,
      _actor_class,
...
public class StateMachinePreloadT
{
  [Newtonsoft.Json.JsonProperty("id")]
  public int Id { get; set; }
  [Newtonsoft.Json.JsonProperty("fsm_key")]
  public string FsmKey { get; set; }
...
static public class StateMachinePreloadVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*Id*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 6 /*FsmKey*/, false)
