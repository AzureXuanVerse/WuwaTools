...
const allSubTypeFiles = fs.readdirSync('./Define/Config/SubType');
dumpFiles(allSubTypeFiles, './Define/Config/SubType');

const allFiles = fs.readdirSync('./Define/Config');
dumpFiles(allFiles, './Define/Config');
